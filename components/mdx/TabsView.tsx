...
import { toValue, type NormalizedTab } from '@/components/mdx/tabs-utils'
...
export function TabsView({ group, defaultValue, tabs }: TabsViewProps) {
      ...
      >
        {tabs.map((t) => (
          <RadixTabs.Trigger
            ...
            value={t.value}
            className={cn(
              '-mb-px whitespace-nowrap px-4 py-2.5 text-[length:var(--text-button)] font-medium',
